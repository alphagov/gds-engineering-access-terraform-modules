...
| <a name="input_excluded_service_principals"></a> [excluded\_service\_principals](#input\_excluded\_service\_principals) | A list of service principal IDs explicitly excluded in the policy. | `list(string)` | `null` | no |
