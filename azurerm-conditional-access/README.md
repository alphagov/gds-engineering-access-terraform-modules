...
| <a name="input_included_groups"></a> [included\_groups](#input\_included\_groups) | List of group object IDs to include in the policy users condition. | `list(string)` | `[]` | no |
...
| <a name="input_included_users"></a> [included\_users](#input\_included\_users) | List of user IDs or special values (e.g. `All`, `None`) to include. | `list(string)` | <pre>[<br/>  "All"<br/>]</pre> | no |
...
| <a name="input_sign_in_risk_levels"></a> [sign\_in\_risk\_levels](#input\_sign\_in\_risk\_levels) | List of sign-in risk levels to trigger the policy | `list(string)` | `null` | no |
| <a name="input_user_risk_levels"></a> [user\_risk\_levels](#input\_user\_risk\_levels) | List of user risk levels to trigger the policy | `list(string)` | `null` | no |
