...
| <a name="input_insider_risk_levels"></a> [insider\_risk\_levels](#input\_insider\_risk\_levels) | The insider risk level to trigger the policy. This feature requires Microsoft Entra Insider Risk Management. | `list(string)` | `null` | no |
